...
var AdminCommunication = (function () {
    function AdminCommunication() {
        this.disabled = false;
        this.status = { isopen: false };
        this.items = [];
    }
    AdminCommunication.prototype.toggled = function (open) {
        console.log("Dropdown is now:", open);
    };
    AdminCommunication.prototype.toggleDropdown = function ($event) {
        $event.preventDefault();
        $event.stopPropagation();
        this.status.isopen = !this.status.isopen;
        console.log($event);
    };
    AdminCommunication = __decorate([
        core_1.Component({
...
exports.AdminCommunication = AdminCommunication;
